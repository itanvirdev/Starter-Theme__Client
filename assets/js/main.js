...
(function ($) {
	...
	////////////////////////////////////////////////////
	// 00. ss-post__slider activation Js
	if (jQuery(".ss-post__slider").length > 0) {
		let services__slide = new Swiper(".ss-post__slider", {
			slidesPerView: 1,
			spaceBetween: 0,
			loop: true,
			autoplay: {
			...
			// Navigation arrows
			navigation: {
				nextEl: ".ss-gallery-button__next",
				prevEl: ".ss-gallery-button__prev",
			},
			breakpoints: {
				0: {
					slidesPerView: 1,
